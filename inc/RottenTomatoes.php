...
class RottenTomatoes
{
	 ...
	 */
	public function movieSearch($query, $pageLimit = 50, $page = 0) {
		$params = array();
		$params['q'] = $query;
		if ($pageLimit)
	 ...
	 * @return array results
	 */
	public function getMovieReviews($id, $reviewType = self::REVIEW_TYPE_ALL, $pageLimit = 50, $page = 0) {
	 ...
	 * @return array results
	 */
	public function getNewDvdReleases($pageLimit = 50, $page = 0) {
		$params = array();
		if ($pageLimit)
			$params['page_limit'] .= $pageLimit;
		if ($page)
	 ...
	 * @return array results
	 */
	public function getUpcomingMovies($pageLimit = 50, $page = 0) {
		$params = array();
		if ($pageLimit)
			$params['page_limit'] .= $pageLimit;
		if ($page)
	 ...
	 * @return array results
	 */
	public function getMoviesInTheaters($pageLimit = 50, $page = 0) {
		$params = array();
		if ($pageLimit)
			$params['page_limit'] .= $pageLimit;
		if ($page)
	 ...
	 * @return array results
	 */
	public function getOpeningMovies($pageLimit = 50) {
		$params = array();
		if ($pageLimit)
			$params['page_limit'] .= $pageLimit;
	 ...
	 * @return array results
	 */
	public function getMoviesBoxOffice($pageLimit = 50) {
		$params = array();
		if ($pageLimit)
			$params['page_limit'] .= $pageLimit;
	 ...
	 * @return array results
	 */
	public function getDvdTopRentals($pageLimit = 50) {
		$params = array();
		if ($pageLimit)
			$params['page_limit'] .= $pageLimit;
...
$rottenTomatoes = new RottenTomatoes($RTApiKey, 15, '');