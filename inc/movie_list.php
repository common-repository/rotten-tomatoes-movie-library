<?php
// Call From Get Movie List Menu Link
function nt_fn_fetch_movie_list()
{
    ...
    <div class="tablenav top">
      <div class="alignleft actions bulkactions">
        <select name="movie_type" id="movie_type">
          ...
          <option value="opening">Opening Movies</option>
          <option value="upcoming">Upcoming Movies</option>
        </select>
        <input type="button" name="get_movies" id="get_movies" class="button" value="GET Movies" />        
      </div>
...
jQuery(document).ready(function() {	
	jQuery("#movie_type").focus();
	var apikey = "<?php echo $RTApiKey;?>";
	var baseUrl = "http://api.rottentomatoes.com/api/public/v1.0/lists/movies/";	
	// Get Movies
